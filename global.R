...
majorComp_sexFactor           <-  -0.0242882
majorComp_raceFactor          <-   0.0596692
majorComp_ageFactor           <-   0.0028318
majorComp_GastRxnFactor       <-  -0.5105275
majorComp_ColonRxnFactor      <-  -0.8071903
...
majorComp_smokerFactor        <-   0.1309884   
majorComp_hxcopdFactor        <-   0.2158972   
majorComp_dialysisFactor      <-   0.1193262     
majorComp_renafailFactor      <-   0.3735297 
